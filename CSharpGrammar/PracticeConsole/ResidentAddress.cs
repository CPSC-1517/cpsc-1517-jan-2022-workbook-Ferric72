...
namespace PracticeConsole.Data
{
    ...
    //struct, however, is a value type storage where as a class is a
    ...
    public struct ResidentAddress
    {
        ...
        {
            //concern: parameter name is exactly the same as the struct/class
            //  field/property
            //
            //solution: use the keyword this. on your instance item
            //
            //the keyword this references to the instance that you are
            //  currently accessing in your program
            this.Number = Number;
        ...
        //note that no "default" constructor was created because I wish
        //  the program to assign the address with all necessary data
        //  at creation time.

        public override string ToString()
        {
            return $"{Number}, {Address1}, {Address2}, {Unit}, {City}," +
                $"{ProvinceState}";
        }
    }
}
