...
namespace WestWindSystem.BLL
{
    public class ProductServices
    {
        ...
        //  the data does not already exist in the database.
        //This can be done using a Linq query and a given set of 
        //  verification fields.
        //Example: for this product insertion, we will verify that there
        //  is no product record in the database with the same product
        //  name and quantity per unit from the same supplier. If so, throw
        //  an exception.

        //you MUST know whether the table has an identity pkey or not
        //if the table pkey is NOT an identity then you MUST ensure that
        //  the incoming instance of the row HAS a pkey value.
        //if the table pkey is an identity then the database will generate
        //  that value and make it acessible to you AFTER the data has
        //  been committed.

        //Product pkey is an identity attribute.
        //This method optionally (it could be a void method instead) sends the new identity value back to the web
        ...
        public int Product_AddProduct(Product item)
        {
            ...
            //IMPORTANT: the data is in local memory; it has NOT!!!!! yet been
        ...
        //Update
        //update can also have design consideration for validation
        //update may request that you check that the record of interest is
        ...
        public int Product_DeleteProduct(Product item)
        {
            ...
            //Removing a record from your database may be a
            // a) physical act
            //OR
            // b) logical act
            ...
            //      database IF there are existing "children" of the record.
            //      sql "parent" records cannot be deleted if "children" exist
            //      the decision to automatically remove "childen" is a system design
            //      decision.
            ...
            //  this type of delete is done so the "flagged" data is NOT used in daily
            //      processing.
            //  this type of delete will actually be an update to the attribute (property)
            //      of the record.
            //  Look for the attributes such as Active, Discontinued, a special date such
            //      as ReleaseDate
