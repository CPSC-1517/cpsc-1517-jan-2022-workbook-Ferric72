        ...
        public IActionResult OnPostNew()
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    //  you can catch the value in a local variable
        ...
        {            
            ...
            {                
                ...
                {                    
                    ...
                    if (rowaffected > 0)
                    {
                        Feedback = $"Product id ({rowaffected}) has been updated in the system.";
                    }
        ...
        public IActionResult OnPostDelete()
        {
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    if (rowaffected > 0)
                    {
                        Feedback = $"Product id ({rowaffected}) has been discontinued in the system.";
                    }
